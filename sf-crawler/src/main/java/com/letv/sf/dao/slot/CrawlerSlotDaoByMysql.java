 ...
 */
public class CrawlerSlotDaoByMysql extends AbstractDao implements CrawlerSlotDao {

    private static final Logger log = Logger.getLogger(CrawlerSlotDaoByMysql.class);

    public List<CrawlerSlotConfig> getWeiboSlot() {
        return getSlotByType(CrawlerSlotType.weibo.toString(), 1);
    }

    public List<CrawlerSlotConfig> getWeixinSlot() {
        return getSlotByType(CrawlerSlotType.weixin.toString(), 1);
    }

    public List<CrawlerSlotConfig> getZhihuSlot() {
        return getSlotByType(CrawlerSlotType.zhihu.toString(), 1);
    }

    public List<CrawlerSlotConfig> getBaiduSlot() {
        return getSlotByType(CrawlerSlotType.baidu.toString(), 1);
    }
