...
public class Status extends WeiboResponse {
    ...
    public static StatusWapper constructWapperStatusJson(String json) throws WeiboException, JSONException {
    ...
    public String toString() {
        return "SpiderStatus [user=" + user + ", idstr=" + idstr + ", createdAt="
